...
const DEFAULT_CENTER = { lat: 37.5, lng: -96 };
...
export default function MapView({ spots, onMapClick, isPinMode = false, pinnedLocation = null, focusSpot = null }) {
  ...
  // Pan to focusSpot when it changes
  const center = focusSpot && focusSpot.lat && focusSpot.lat !== 0
    ? { lat: focusSpot.lat, lng: focusSpot.lng }
    : isPinMode && pinnedLocation
    ? pinnedLocation
    : DEFAULT_CENTER;

  const zoom = focusSpot && focusSpot.lat && focusSpot.lat !== 0 ? 15 : 5;
  ...
  if (!isLoaded) return <div style={{ width: "100%", height: isPinMode ? "650px" : "70vh", background: "#1a1a2e" }} />;
        ...
        >
          <div style={{ background: "#111", color: "#f97316", padding: 8, borderRadius: 8 }}>
            ...
            {active.lat && active.lat !== 0 && (
                ...
                <a href={`https://www.google.com/maps/dir/?api=1&destination=${active.lat},${active.lng}`}
                target="_blank"
                rel="noreferrer"
                style={{
